...
API_KEY = "sk-TmkvvXuqLkF31SvtvTF3M8gBrHZVRwBZjpbRhhsohIkgFPnX"  # claude
...
def query_model():
    ...
    try:
        ...
        print("\n[Timer] Waiting for LLM response...")
        ...
        if response.status_code == 200:
            ...
            print(f"[Metrics]  LLM generation completed! Latency: {latency:.2f} seconds")
...
def tlc_feedback_loop(initial_tla_code, max_attempts=3):
...
def main():
    ...
    pseudo_file = "ADDRBC.txt"
    json_file = "ADDRBC.json"
