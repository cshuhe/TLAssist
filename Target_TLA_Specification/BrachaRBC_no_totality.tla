...
Init ==
    ...
    /\ IF sender \in Correct
       ...
       ELSE receivedS \in [Correct -> SUBSET V]
...
Validity ==
    (sender \in Correct) =>
        LET Val == IF sender \in Correct
                   THEN CHOOSE v \in V : v \in receivedS[sender]
                   ELSE ""
